...
func PostReq(httpClient *http.Client, mac *auth.Credentials, url string, reqParam interface{}, ret interface{}) *resInfo {
	info := newResInfo()
	var reqData []byte
	var err error
...
func callReq(httpClient *http.Client, req *http.Request, mac *auth.Credentials, info *resInfo, ret interface{}) (oinfo *resInfo) {
	oinfo = info
